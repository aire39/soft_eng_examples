...
class BertramFactory : public AbstractFactory
{
    public:
        BertramFactory(const BertramFactory&) = delete;
        void operator=(const BertramFactory&) = delete;
        ~BertramFactory() = default;

        static AbstractFactory* instance()
        {
            static BertramFactory factory;
            return &factory;
        }
